...
<body class="hold-transition sidebar-mini">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="productsSellByDate.php" class="nav-link active">
                    <i class="far fas fa-cart-arrow-down nav-icon"></i>
                  ...
                  <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                          <label for="codeProduit">Date debut</label>
                          <input type="date" class="form-control" id="dateDebut" placeholder="Code">
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                          <label for="codeProduit">Date fin</label>
                          <input type="date" class="form-control" id="dateFin" placeholder="Code">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                          
                          <label for="codeProduit">.</label>
                          <input type="button" id="afficher" class="form-control btn btn-info" value="Afficher" placeholder="Code">
                        </div>
                    </div>
                  </div>
                </div>
          ...
          <form id="forms" method="POST">
            <div class="container modal-body">
              <div class="form-row">
                ...
                <div class="form-group col-md-4">
                  <label for="libelleProduit">Libelle du produit</label>
                  <input type="text" class="form-control" id="libelleProduit" name="libelleProduit" placeholder="Libelle">
                </div>
                <div class="form-group col-md-4">
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  ...
                  <input type="number" readonly class="form-control" name="qteMinimal" id="qteMinimal" placeholder="Min">

                </div>
                <div class="form-group col-md-4">
                  <label for="qteMaximal">Quantité maximale</label>
                  <input type="number" class="form-control" name="qteMaximal" id="qteMaximal" placeholder="Max">
                </div>
                <div class="form-group col-md-4">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="number" class="form-control" name="prixAchat" id="prixAchat" placeholder="Prix">
                </div>
                <div class="form-group col-md-4">
                  <label for="prixUnit">Prix de vente du produit</label>
                  <input type="number" class="form-control" name="prixUnit" id="prixUnit" placeholder="Prix">
                </div>
                <div class="form-group col-md-4">
                  <label for="securityDelay">Delai de sécurité</label>
                  <input type="number" class="form-control" name="securityDelay" id="securityDelay" placeholder="">
                </div>
  ...
  <script>
    ...
    $('#afficher').click(function(e) {
      ...
      $.post('getProductSellByDate.php', {dateDebut: dateDebut, dateFin: dateFin}, function(data){
      ...
      $('#forms').validate({
        ...
        messages: {
          ...
          prixUnit: {
            ...
            required: "Le prix unitaire du produit est requis !",
          },
          securityDelay: {
